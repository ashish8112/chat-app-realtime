...
// <ErrorBoundary fallbackRender={({ error, resetErrorBoundary }) => (   //I used this previously but not now created another component to make it more reusable check app.jsx
//             <div role="alert">
